...
| 2 | `{`                                                 |
|   |                                                     |
| 3 | `float` `x = -1.0 + float((gl_VertexID & 1) << 2);` |
|   |                                                     |
| 4 | `float` `y = -1.0 + float((gl_VertexID & 2) << 1);` |
|   |                                                     |
| 5 | `gl_Position = vec4(x, y, 0, 1);`                   |
|   |                                                     |
| 6 | `}`                                                 |
+===+=====================================================+
+---+-----------------------------------------------------+
...
| 4  | `{`                                                 |
|    |                                                     |
| 5  | `float` `x = -1.0 + float((gl_VertexID & 1) << 2);` |
|    |                                                     |
| 6  | `float` `y = -1.0 + float((gl_VertexID & 2) << 1);` |
|    |                                                     |
| 7  | `texCoord.x = (x+1.0)*0.5;`                         |
|    |                                                     |
| 8  | `texCoord.y = (y+1.0)*0.5;`                         |
|    |                                                     |
| 9  | `gl_Position = vec4(x, y, 0, 1);`                   |
|    |                                                     |
| 10 | `}`                                                 |
+====+=====================================================+
+----+-----------------------------------------------------+
